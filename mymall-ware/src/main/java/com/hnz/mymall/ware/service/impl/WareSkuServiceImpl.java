...
import com.hnz.common.to.mq.StockDetailTo;
...
import com.hnz.mymall.ware.feign.OrderFeignService;
import com.hnz.mymall.ware.feign.ProductFeignService;
import com.hnz.mymall.ware.service.WareOrderTaskDetailService;
import com.hnz.mymall.ware.service.WareOrderTaskService;
import com.hnz.mymall.ware.vo.OrderItemVo;
import com.hnz.mymall.ware.vo.OrderVo;
...
import com.hnz.mymall.ware.dao.WareSkuDao;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    public boolean orderLockStock(WareSkuLockVo vo) {
        ...
        for (SkuWareHasStock hasStock : collect) {
            ...
            //2、锁定失败。前面保存的工作单信息都回滚了。发送出去的消息，即使要解锁库存，由于在数据库查不到指定的id，所以就不用解锁
