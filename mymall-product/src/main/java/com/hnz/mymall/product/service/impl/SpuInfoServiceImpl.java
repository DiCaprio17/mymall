...
import com.hnz.common.constant.ProductConstant;
import com.hnz.common.to.SkuHasStockVo;
import com.hnz.common.to.SkuReductionTo;
import com.hnz.common.to.SpuBoundTo;
import com.hnz.common.to.es.SkuEsModel;
import com.hnz.common.utils.R;
import com.hnz.mymall.product.entity.*;
import com.hnz.mymall.product.feign.CouponFeignService;
import com.hnz.mymall.product.feign.SearchFeignService;
import com.hnz.mymall.product.feign.WareFeignService;
import com.hnz.mymall.product.service.*;
import com.hnz.mymall.product.vo.*;
...
import com.hnz.mymall.product.dao.SpuInfoDao;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void up(Long spuId) {
        ...
        try {
            ...
            R r = wareFeignService.getSkuHasStock(skuInfoSkuIds);
        ...
        //TODO 5. 将数据发送给ES进行保存；mymall-search
        ...
        if (statusUp.getCode() == 0) {
            ...
            //远程调用失败
            //TODO 7.重复调用的问题，接口幂等性：远程接口调用失败，重试机制？
            //Feign调用流程
            /**
             * 1.构造请求数据，将对象转为json
